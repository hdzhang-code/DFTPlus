...
def parseArgument():
    ...
    parser.add_argument('--inTaskEpoch', type=int, default=100)
...
def main():
    ...
    trainingParam = {"shot":args.shot,  \
            ...
            "wandbRunName": "AU%d-MLM%.2f-lrBackbone%.5f-lrCls%.5f-Te%s-%s-seed%d-st%s"%(args.augNum, args.MLMWeight, args.lrBackbone, args.lrClsfier, args.testDataset, args.LMName, args.seed, args.shot), \
            "wandbConfig": {},  \
    ...
    model, lc = trainer.train(model, tok, dataset, dataloader, unlabTensorData, logLevel='INFO')
